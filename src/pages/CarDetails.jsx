      ...
      <div className="car-details-grid">
        ...
        <div className="car-details-content">
          ...
          <div className="car-details-tags">
            {car.category && <span>Category: {car.category}</span>}
          ...
          <div className="booking-date-section">
            ...
            <label>
              Pickup Date & Time
              <input type="datetime-local" value={pickupAt} onChange={(e) => { setPickupAt(e.target.value); setAvailableQuantity(null); }} />
            </label>
            <label>
              Return Date & Time
              <input type="datetime-local" value={returnAt} onChange={(e) => { setReturnAt(e.target.value); setAvailableQuantity(null); }} />
            </label>
            <button type="button" className="check-availability-button" onClick={checkAvailability} disabled={checking}>
              {checking ? 'Checking...' : 'Check Availability'}
            </button>
            {availableQuantity !== null && (
              <div className="availability-result">
                {availableQuantity > 0 ? (
                  <p>Available cars: <strong>{availableQuantity}</strong></p>
                ) : (
